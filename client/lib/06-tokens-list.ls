@tokens-list=-> new Array do
	* address:\0x8f8bf891529bb2ea3450695df75b0553e43bcd7b name:'Sample token' link:'https://kovan.etherscan.io/' description:'ERC20 token for development' 
	* address:\0x86fa049857e0209aa7d9e616f7eb3b3b78ecfdb0 name:'EOS' link:'https://eos.io/' description:'EOS is a new cryptocurrency' 
	* address:\0x9a642d6b3368ddc662CA244bAdf32cDA716005BC name:'Qtum' link:'https://qtum.org/' description:'Combining a modified Bitcoin Core infrastructure with an intercompatible version of the Ethereum Virtual Machine (EVM), Qtum merges the reliability of Bitcoin’s unfailing blockchain with the endless possibilities provided by smart contracts.' 
	...
	* address:\0xa74476443119A942dE498590Fe1f2454d7D4aC0d name:'GOLEM (GNT)'  link:'https://golem.network/' description:'Golem is a global, open sourced, decentralized supercomputer that anyone can access. It\'s made up of the combined power of user\'s machines, from personal laptops to entire datacenters.' 
	* address:\0xB97048628DB6B661D4C2aA833e95Dbe1A905B280 name:'TenXPay' link:'https://www.tenx.tech/' description:'Convert and spend virtual currencies. Anytime. Anywhere.' 
