var this$ = this;
this.prelude__init = function(it){
	return this$[it] = prelude[it];
};
...
this.blaze__init = function(tag){
	return this$[tag] = HTML[tag.toUpperCase()];
};
...
this.main_blaze = HTML['MAIN'];
this.header_blaze = HTML['HEADER'];
this.D = function(cls){
	var args, res$, i$, to$;
	res$ = [];
